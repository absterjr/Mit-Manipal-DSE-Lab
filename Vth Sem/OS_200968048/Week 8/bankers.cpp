...
int main()
{
       ...
       printf("Enter allocated resources of type A: \n");
        for(i=0;i<n;i++) scanf("%d", &(alloc[i][0]));
        printf("Enter allocated resources of type B: \n");
        for(i=0;i<n;i++) scanf("%d", &(alloc[i][1]));
        printf("Enter allocated resources of type C: \n");
        for(i=0;i<n;i++) scanf("%d", &(alloc[i][2]));
        for(i=0;i<n;i++) for(j=0;j<3;j++) talloc[i][j] = alloc[i][j];

       printf("Enter maximum resources of type A: \n");
        for(i=0;i<n;i++) scanf("%d", &(max[i][0]));
        printf("Enter maximum resources of type B: \n");
        for(i=0;i<n;i++) scanf("%d", &(max[i][1]));
        printf("Enter maximum resources of type C: \n");
       ...
       flag = bank(n);
        if(flag==1) printf("System is safe\n");
